...
function textStyle2() {
  alert("Поздравляю⭐ Вы нашли мою ещё одну пасхалку👏👏 Вы очень внимально читаете материал!👍");
}
function textStyle3() {
  alert("Поздравляю⭐ Вы нашли мою ещё одну пасхалку👏👏 Это удивительно, ведь она была очень хорошо спрятана!👀");
}
